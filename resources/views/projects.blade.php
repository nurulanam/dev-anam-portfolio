  ...
  <main>
        ...
        <div class="grid grid-cols-12 gap-y-10 md:gap-y-0 md:gap-x-4 items-center">
          ...
          <div class="col-span-12 order-1 md:col-span-6 md:order-2 flex justify-center md:justify-end" data-scroll data-scroll-speed="3">
            <div class="relative w-fit h-fit">
                <img src="./../img/projects-banner-img.png" class="banner-avater opacity-0" alt="">
                <img class="absolute brand opacity-0 -bottom-8 -left-10" src="./../img/brand.png" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="min-h-screen bg-black-main relative" id="allProjects" data-scroll data-scroll-section>
        <div class="container py-28 px-4">
            <div class="grid grid-cols-12 gap-y-10 md:gap-y-6 gap-6 items-stretch">
                <div class="col-span-4 overflow-hidden p-4 pb-6 group rounded-lg bg-gradient-to-tl from-black-main from-15%  via-[#222121] via-40%  to-gray-main to-80% backdrop-blur-sm space-y-4 transition-all ease-linear">
                    <div class="relative">
                        <div class="card-img rounded-lg overflow-hidden">
                            <img class="shadow-md group-hover:scale-110 transition-all ease-linear" src="./../img/bannergredient1.png" alt="">
                        </div>
                    ...
                    <div class="absolute rounded-lg bg-gradient-to-tl from-red-main from-15%  via-transparent via-40% to-transparent to-80% flex items-center transition-all ease-linear opacity-0 group-hover:opacity-100 w-24 h-24 right-0 bottom-0">
                        <img class="-rotate-45 z-[2]" src="./../img/projects/oneStopLogo.png" alt="">
                    </div>
                </div>
                <div class="col-span-4 overflow-hidden p-4 pb-6 group rounded-lg bg-gradient-to-tl from-black-main from-15%  via-[#222121] via-40%  to-gray-main to-80% backdrop-blur-sm space-y-4 transition-all ease-linear">
                    <div class="relative">
